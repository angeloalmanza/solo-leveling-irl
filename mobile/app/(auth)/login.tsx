...
const styles = StyleSheet.create({
  ...
  title: { color: Colors.text, fontSize: 36, fontWeight: '800', letterSpacing: 4, textAlign: 'center', lineHeight: 44 },
  ...
  buttonText: { color: Colors.background, fontSize: 14, fontWeight: '800', letterSpacing: 3 },
